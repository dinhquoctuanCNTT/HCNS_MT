...
export default function AdminSidebar({ isOpen }: AdminSidebarProps) {
  ...
  // ── NHÂN SỰ: state cho sub-menus lồng nhau ──
            ...
            <div className="admin-sidebar__submenu">
              ...
              {openKeToanMTPARTS && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/ke-toan/mtparts/quy-trinh",
                      label: "1. Quy trình phòng kế toán",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/quy-tien-mat",
                      label: "2. Quỹ tiền mặt và ngân hàng",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/tong-hop-chi-phi",
                      label: "3. Tổng hợp các chi phí",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/cong-no-phai-thu",
                      label: "4. Công nợ phải thu",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/cong-no-phai-tra",
                      label: "5. Công nợ phải trả",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/kho-hang-hoa",
                      label: "6. Kho hàng hóa",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/bao-cao-tai-chinh",
                      label: "7. Báo cáo tài chính hàng tháng",
                    },
                    {
                      to: "/admin/ke-toan/mtparts/bao-cao-vat",
                      label: "8. Báo cáo VAT(NBo)",
                    },
              ...
              {openKeToanMTH && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/ke-toan/mth/tu-tai-lieu",
                      label: "1. Tủ tài liệu phòng kế toán",
                    },
                    {
                      to: "/admin/ke-toan/mth/dao-tao-kt",
                      label: "2. Đào tạo KT",
                    },
                    {
                      to: "/admin/ke-toan/mth/cong-viec-ktv",
                      label: "3. Công việc của kế toán viên",
                    },
                    {
                      to: "/admin/ke-toan/mth/tai-lieu-dao-tao",
                      label: "4. Tài liệu đào tạo KTBH và Kho",
                    },
                    {
                      to: "/admin/ke-toan/mth/hop-giao-ban",
                      label: "Họp giao ban",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
              ...
              {openKeToanMTPaint && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/ke-toan/mt-paint/quy-trinh",
                      label: "1. Quy trình phòng kế toán MT",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/quy-tien-mat",
                      label: "2. Quỹ tiền mặt và chuyển khoản",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/tong-hop-chi-phi",
                      label: "3. Tổng hợp các chi phí",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/cong-no-phai-thu",
                      label: "5. Công nợ phải thu",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/kho-pha-le",
                      label: "6. Kho pha lẻ",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/bao-cao-tai-chinh",
                      label: "7. Báo cáo tài chính hàng tháng",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/kho-hang-hoa",
                      label: "8. Kho hàng hóa",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/hoa-don-vat",
                      label: "9. Hóa đơn VAT",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/cong-no-trong-nuoc",
                      label: "10. Công nợ phải trả trong nước",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/cong-no-nuoc-ngoai",
                      label: "11. Công nợ phải trả nước ngoài",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/ngan-sach",
                      label: "12. Ngân sách",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/bao-cao-bi",
                      label: "13. Học làm báo cáo BI",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/hang-hu-hong",
                      label: "14. Hồ sơ hàng hư hỏng hàng năm",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/du-lieu-pm",
                      label: "15. Dữ liệu pm",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/thue",
                      label: "16. Thuế MT Paint",
                    },
                    {
                      to: "/admin/ke-toan/mt-paint/doi-chieu-136-336",
                      label: "17. Báo cáo đối chiếu 136 và 336",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openKeToanMHM && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/ke-toan/mhm/quy-trinh",
                      label: "1. Quy trình phòng kế toán",
                    },
                    {
                      to: "/admin/ke-toan/mhm/quy-tien-mat",
                      label: "2. Quỹ tiền mặt và ngân hàng",
                    },
                    {
                      to: "/admin/ke-toan/mhm/cong-no-phai-thu",
                      label: "3. Công nợ phải thu",
                    },
                    {
                      to: "/admin/ke-toan/mhm/cong-no-phai-tra",
                      label: "4. Công nợ phải trả",
                    },
                    {
                      to: "/admin/ke-toan/mhm/chi-phi-cong-cu",
                      label: "5. Chi phí đầu tư thiết bị công cụ",
                    },
                    {
                      to: "/admin/ke-toan/mhm/chi-phi-kinh-doanh",
                      label: "6. Chi phí kinh doanh",
                    },
                    {
                      to: "/admin/ke-toan/mhm/chi-phi-san-xuat",
                      label: "7. Chi phí sản xuất",
                    },
                    {
                      to: "/admin/ke-toan/mhm/chi-phi-van-hanh",
                      label: "8. Chi phí vận hành",
                    },
                    { to: "/admin/ke-toan/mhm/kho", label: "9. Kho" },
                    {
                      to: "/admin/ke-toan/mhm/bao-cao-thue",
                      label: "10. Báo cáo thuế",
                    },
                    {
                      to: "/admin/ke-toan/mhm/hoa-don",
                      label: "11. Hóa đơn đầu vào và đầu ra",
                    },
                    {
                      to: "/admin/ke-toan/mhm/bao-cao-tai-chinh",
                      label: "12. Báo cáo tài chính hàng tháng",
                    },
                    {
                      to: "/admin/ke-toan/mhm/ke-hoach-ban-hang",
                      label: "13. Kế hoạch bán hàng",
                    },
                    {
                      to: "/admin/ke-toan/mhm/theo-doi-boc-tach",
                      label: "14. Theo dõi khác - bóc tách chi phí",
                    },
                    {
                      to: "/admin/ke-toan/mhm/tinh-gia-von",
                      label: "15. Tính giá vốn MHM",
                    },
            ...
            <div className="admin-sidebar__submenu">
              ...
              {openDaoTaoSoDo && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/dao-tao/so-do-to-chuc/he-sinh-thai",
                      label: "1.1. Hệ sinh thái MTH",
                    },
                    {
                      to: "/admin/dao-tao/so-do-to-chuc/danh-muc-cty",
                      label: "1.2. Danh mục công ty, chi nhánh, phòng ban",
                    },
                    {
                      to: "/admin/dao-tao/so-do-to-chuc/ho-so-nang-luc",
                      label: "1.3. Hồ sơ năng lực các công ty",
                    },
                    {
                      to: "/admin/dao-tao/so-do-to-chuc/chuc-nang-pb",
                      label: "1.4. Chức năng nhiệm vụ phòng ban",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openDaoTaoNhanSu && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/dao-tao/nhan-su-360/danh-sach",
                      label: "2.1. Danh sách nhân sự",
                    },
                    {
                      to: "/admin/dao-tao/nhan-su-360/bmtcv-kpi",
                      label: "2.2. BMTCV + KPI",
                    },
                    {
                      to: "/admin/dao-tao/nhan-su-360/khung-nang-luc",
                      label: "2.3. Khung năng lực",
                    },
                    {
                      to: "/admin/dao-tao/nhan-su-360/lo-trinh",
                      label: "2.4. Lộ trình phát triển",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openDaoTaoQuyTrinh && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/dao-tao/quy-trinh/quy-trinh-chung",
                      label: "1. Quy trình chung PĐT",
                    },
                    {
                      to: "/admin/dao-tao/quy-trinh/bien-ban-hop",
                      label: "Biên bản họp hàng tháng",
                    },
                    {
                      to: "/admin/dao-tao/quy-trinh/ke-hoach-tuan-thang",
                      label: "2. Kế hoạch tuần/tháng PĐT",
                    },
                    {
                      to: "/admin/dao-tao/quy-trinh/bao-cao-ngay",
                      label: "3. Báo cáo ngày/tuần/tháng",
                    },
                    {
                      to: "/admin/dao-tao/quy-trinh/bao-cao-hoat-dong",
                      label: "4. Báo cáo tháng hoạt động đào tạo",
                    },
                    {
                      to: "/admin/dao-tao/quy-trinh/giay-to-hc",
                      label: "5. Giấy tờ hành chính",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openDaoTaoTaiLieu && (
                <div className="sidebar-sublevel">
                  {[
                    ...
                    {
                      to: "/admin/dao-tao/tai-lieu/mtpaints",
                      label: "2. MTPaints",
                    },
                    { to: "/admin/dao-tao/tai-lieu/mhm", label: "3. MHM" },
                    {
                      to: "/admin/dao-tao/tai-lieu/mtparts",
                      label: "4. MTparts",
                    },
                    {
                      to: "/admin/dao-tao/tai-lieu/mtshop",
                      label: "5. MTShop",
                    },
                    { to: "/admin/dao-tao/tai-lieu/mtpsi", label: "6. MTPSI" },
                    {
                      to: "/admin/dao-tao/tai-lieu/mteducation",
                      label: "7. MTEducation",
                    },
                    {
                      to: "/admin/dao-tao/tai-lieu/mtsoft",
                      label: "8. MTSoft",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
              ...
              {openDaoTaoHoatDong && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/dao-tao/hoat-dong/chuong-trinh",
                      label: "1. Chương trình đào tạo theo công ty",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/nhu-cau",
                      label: "Nhu cầu đào tạo toàn hệ thống",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/ke-hoach",
                      label: "Kế hoạch, lịch đào tạo trong tháng",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/hoi-nhap",
                      label: "2. Đào tạo hội nhập",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/chuyen-mon",
                      label: "3. Đào tạo chuyên môn",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/nang-cao",
                      label: "4. Đào tạo nâng cao (theo khung năng lực)",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/thue-ngoai",
                      label: "5. Đào tạo thuê ngoài",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/san-pham-moi",
                      label: "6. Đào tạo sản phẩm mới",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/nhac-lai",
                      label: "7. Đào tạo nhắc lại",
                    },
                    {
                      to: "/admin/dao-tao/hoat-dong/bao-cao-tong-hop",
                      label: "8. Báo cáo tổng hợp",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openDaoTaoDanhGia && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/dao-tao/danh-gia/ket-qua-toan-he-thong",
                      label: "1. Kết quả đào tạo toàn hệ thống",
                    },
                    {
                      to: "/admin/dao-tao/danh-gia/khao-sat",
                      label: "2. Khảo sát sau đào tạo",
                    },
                    {
                      to: "/admin/dao-tao/danh-gia/tong-hop-phan-tich",
                      label: "3. Tổng hợp, phân tích kết quả",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openDaoTaoLienKet && (
                <div className="sidebar-sublevel">
                  {[
                    ...
                    {
                      to: "/admin/dao-tao/lien-ket/truong",
                      label: "2. Trường",
                    },
                    {
                      to: "/admin/dao-tao/lien-ket/hoi-thi-tay-nghe",
                      label: "3. Hội thi tay nghề",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
            ...
            <div className="admin-sidebar__submenu">
              ...
              {openPMMH1 && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/phan-mem-mua-hang/ncc/thong-tin",
                      label: "1.1. Thông tin nhà cung cấp",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/ncc/danh-gia",
                      label: "1.2. Đánh giá NCC",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openPMMH2 && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/thong-tin",
                      label: "2.1. Thông tin nhân sự",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/bmtcv-thuong",
                      label: "2.2. BMTCV + thưởng P3",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/he-thong-bc",
                      label: "2.3. Hệ thống Báo cáo",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/chien-luoc",
                      label: "2.4. Chiến lược, mục tiêu phòng mua hàng",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/cl-muc-tieu-nam",
                      label: "2.4.0. Chiến lược, mục tiêu năm",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/ke-hoach-nam",
                      label: "2.4.1. Kế hoạch, hành động năm",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/p3-nam",
                      label: "2.4.2. P3 năm",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/dao-tao",
                      label: "2.5. Đào tạo",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/nhan-su/s5",
                      label: "2.6. S5",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
              ...
              {openPMMH3 && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/phan-mem-mua-hang/san-pham/ke-hoach-sp-moi",
                      label: "3.1. Kế hoạch triển khai sản phẩm mới",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/san-pham/bang-gia-von",
                      label: "3.2. Bảng giá vốn lợi nhuận",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/san-pham/thong-tin-sp",
                      label: "3.3. Thông tin sản phẩm",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/san-pham/top-ban-nhieu",
                      label: "3.4. Top sản phẩm bán nhiều đột biến",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/san-pham/top-ban-cham",
                      label: "3.5. Top sản phẩm bán chậm",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/san-pham/canh-bao-kho",
                      label: "3.6. Cảnh báo hàng tồn kho cần date",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openPMMH4 && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/phan-mem-mua-hang/dat-hang/ke-hoach-nam",
                      label: "4.1. Kế hoạch đặt hàng theo năm",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/dat-hang/ke-hoach-thang",
                      label: "4.2. Kế hoạch đặt hàng theo tháng",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/dat-hang/theo-doi-don",
                      label: "4.3. Theo dõi đơn đặt hàng",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/dat-hang/giam-gia-ncc",
                      label: "4.4. Giảm giá mua từ NCC",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/dat-hang/khieu-nai",
                      label: "4.5. Khiếu nại đơn hàng",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              {openPMMH5 && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/phan-mem-mua-hang/thanh-toan/ke-hoach-ncc",
                      label: "5.1. Kế hoạch thanh toán NCC",
                    },
                    {
                      to: "/admin/phan-mem-mua-hang/thanh-toan/cong-no",
                      label: "5.2. Đảm bảo thanh toán công nợ",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
              ...
              <NavLink
                to="/admin/phan-mem-mua-hang/chi-phi"
                className={({ isActive }) =>
                  isActive
                    ? "admin-sidebar__sublink admin-sidebar__sublink--active"
                    : "admin-sidebar__sublink"
              ...
              <NavLink
                to="/admin/phan-mem-mua-hang/ty-gia"
                className={({ isActive }) =>
                  isActive
                    ? "admin-sidebar__sublink admin-sidebar__sublink--active"
                    : "admin-sidebar__sublink"
            ...
            <div className="admin-sidebar__submenu">
              ...
              {openBanHang1 && (
                <div className="sidebar-sublevel">
                  {[
                    {
                      to: "/admin/ban-hang/thong-tin-kh-360",
                      label: "1.1 Thông tin khách hàng 360",
                    },
                    {
                      to: "/admin/ban-hang/dinh-huong-kh-360",
                      label: "1.1.1 Định hướng khách hàng 360",
                    },
                    {
                      to: "/admin/ban-hang/nhan-su-pbh-360",
                      label: "1.2 Nhân sự phòng bán hàng 360",
                    },
                    {
                      to: "/admin/ban-hang/co-cau-to-chuc",
                      label: "1.2.0 Cơ cấu tổ chức",
                    },
                    {
                      to: "/admin/ban-hang/thong-tin-nhan-su",
                      label: "1.2.1 Thông tin nhân sự",
                    },
                    {
                      to: "/admin/ban-hang/danh-gia-luong-3p",
                      label: "1.2.2 Đánh giá lương 3P",
                    },
                    {
                      to: "/admin/ban-hang/co-che-bh-tieu-chuan",
                      label: "1.2.3 Cơ chế bán hàng tiêu chuẩn",
                    },
                    {
                      to: "/admin/ban-hang/co-che-bh-thuc-te",
                      label: "1.2.4 Cơ chế bán hàng thực tế",
                    },
                    {
                      to: "/admin/ban-hang/doi-thu-canh-tranh",
                      label: "1.3 Thông tin đối thủ cạnh tranh",
                    },
                    {
                      to: "/admin/ban-hang/san-pham-gia-ban",
                      label: "1.4 Thông tin sản phẩm và giá bán",
                    },
                    {
                      to: "/admin/ban-hang/kh-noi-ngoai-tinh",
                      label: "1.5 Kế hoạch BH nội tỉnh và ngoại tỉnh",
                    },
                    {
                      to: "/admin/ban-hang/kh-bh-noi-ngoai",
                      label: "1.5.1 Kế hoạch BH nội tỉnh và ngoại tỉnh",
                    },
                    {
                      to: "/admin/ban-hang/kq-bh-noi-ngoai",
                      label: "1.5.2 Kết quả BH nội tỉnh và ngoại tỉnh",
                    },
                    {
                      to: "/admin/ban-hang/top-20-kh-80-ds",
                      label: "1.6 Top 20% KH đóng góp 80% doanh số",
                    },
                    {
                      to: "/admin/ban-hang/kh-khong-mua-30-60-90",
                      label: "1.7 KH không mua hàng 30/60/90 ngày",
                    },
                    {
                      to: "/admin/ban-hang/kh-mua-giam-20",
                      label: "1.8 KH có mức mua giảm từ 20% tháng trước",
                    },
                    {
                      to: "/admin/ban-hang/ds-chi-phi-ln-kh",
                      label: "1.9 Doanh số - chi phí - lợi nhuận theo KH",
                    },
                    {
                      to: "/admin/ban-hang/ho-so-co-hoi-dau-tu",
                      label: "1.9.1 Hồ sơ cơ hội đầu tư",
                    },
                    {
                      to: "/admin/ban-hang/hang-muc-dau-tu",
                      label: "1.9.2 Hạng mục đầu tư ban đầu",
                    },
                    {
                      to: "/admin/ban-hang/chi-phi-van-hanh",
                      label: "1.9.3 Chi phí vận hành",
                    },
                    {
                      to: "/admin/ban-hang/ke-hoach-ds-gia-dinh",
                      label: "1.9.4 Kế hoạch doanh số và giả định hiệu quả",
                    },
                    {
                      to: "/admin/ban-hang/danh-gia-phe-duyet",
                      label: "1.9.5 Đánh giá / phê duyệt / cảnh báo",
                    },
                    {
                      to: "/admin/ban-hang/quan-ly-cong-no",
                      label: "1.10 Quản lý công nợ",
                    },
                    {
                      to: "/admin/ban-hang/sales-roadmap",
                      label: "1.11 Quản lý BH theo Sales Roadmap",
                    },
                    {
                      to: "/admin/ban-hang/ho-so-du-an-bh",
                      label: "1.11.1 Hồ sơ dự án bán hàng",
                    },
                    {
                      to: "/admin/ban-hang/tien-do-roadmap",
                      label: "1.11.2 Tiến độ roadmap 11 bước",
                    },
                    {
                      to: "/admin/ban-hang/nhat-ky-hanh-dong",
                      label: "1.11.3 Nhật ký hành động",
                    },
                    {
                      to: "/admin/ban-hang/y-kien-dinh-huong",
                      label: "1.11.4 Ý kiến / định hướng / kết quả",
                    },
                    {
                      to: "/admin/ban-hang/muc-tieu-ke-hoach",
                      label: "1.12 Mục tiêu / kế hoạch / kết quả theo công ty",
                    },
                  ].map(({ to, label }) => (
                    <NavLink
                      key={to}
